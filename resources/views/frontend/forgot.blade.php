...
<head>
    ...
    <title>Forgot Password | Admission Process</title>
    <!-- google font -->
    <style type="text/css">
        h6 {
...
<div class="limiter">
    <div class="container-login100 bg_ab">
        <div class="wrap-login100">
            ...
            <form {{--id="user_login"--}} action="{{url('reset')}}" method="post">
                @csrf
            <span class="">
              <img alt="" src="{{asset('frontend/assets/images/logo.webp')}}" style="width: 100%"/>
            </span>
                <span class="login100-form-title p-t-27"> Forgot Password </span>
                <p
                    style="
                color: #276c2a;
                padding-bottom: 20px;
              ...
              "
                ...
                <p style="text-align: center; color: red;">@if(session('msg')) {{session('msg')}} @endif</p>
               ...
               <a class="txt1" style="color: #1d4ca1" href="{{url('login')}}">
                    Login
                </a>
                <div>
